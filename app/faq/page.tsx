...
const Faq = () => {
  return (
    <div className="container md:p-10 lg:p-20 bg-gray-50 dark:bg-[#181c20] flex flex-col">
      <div className="flex flex-col items-center my-10 md:mt-0">
        <AnimatedCharacters className="text-4xl font-bold" type="heading1" text="Frequently Asked Questions" />
        <p className="font-semibold lg:text-[20px] md:text-[18px] text-center xs:text-[14px] text-[#11142D] dark:text-white">
      ...
      >
        <AccordionItem value="item-1">
          <AccordionTrigger className="text-1xl md:text-[20px] font-bold text-[#11142D] dark:text-white text-start">
            How can I order food from a different country on BiteZ?
          </AccordionTrigger>
          <AccordionContent className="w-[60%]">
